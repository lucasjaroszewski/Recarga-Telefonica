...
response = requests.put(BASE + "PhoneRecharges/1", {'company_id': 'claro_12', 'product_id': 'claro_10', 'value': 10.0, 'phone_number': 5511999999999})
...
response = requests.put(BASE + "PhoneRecharges/2", {'company_id': 'claro_12', 'product_id': 'claro_20', 'value': 20.0, 'phone_number': 5511999999999})
